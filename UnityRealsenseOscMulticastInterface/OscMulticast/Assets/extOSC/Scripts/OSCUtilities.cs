...
namespace extOSC
{
    public static class OSCUtilities
    {
        ...
        {
            return (T)ByteToStruct(typeof(T), data);
        }
        ...
        public static bool ToVector4(this OSCMessage message, out Vector4 value, bool force = false)
        {
            ...
            if (values.Length >= 4)
            {
                ...
                value = new Vector4(firstValue.FloatValue, secondValue.FloatValue, thirdValue.FloatValue, fourthValue.FloatValue);
        ...
        public static bool IsSubclassOf(Type firstType, Type secondType)
        {
#if !NETFX_CORE
            return (firstType.IsSubclassOf(secondType) || firstType == secondType);
#else
            return (firstType.GetTypeInfo().IsSubclassOf(secondType) || firstType == secondType);
#endif
        }
